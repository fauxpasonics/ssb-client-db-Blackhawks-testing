...
GO
CREATE NONCLUSTERED INDEX [IX_FACTATTENDANCE_DIMEVENTID_INCLUDE] ON [dbo].[FactAttendance_V2] ([DimEventId]) INCLUDE ([DimScanGateId], [DimSeatId], [DimTicketCustomerId])
GO
