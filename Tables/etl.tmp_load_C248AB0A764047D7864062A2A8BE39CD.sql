CREATE TABLE [etl].[tmp_load_C248AB0A764047D7864062A2A8BE39CD]
(
...
[customer_MatchKey] [nvarchar] (258) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C248AB0A764047D7864062A2A8BE39CD_ss] ON [etl].[tmp_load_C248AB0A764047D7864062A2A8BE39CD] ([SourceSystem], [SSID])
GO
