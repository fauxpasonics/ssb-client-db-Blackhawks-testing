...
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_RetailEvent] ([ETL__Source])
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_RetailEvent] ([retail_event_id])
GO
