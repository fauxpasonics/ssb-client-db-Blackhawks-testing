...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_tmarc_RAW_Journal] ON [tmarc].[RAW_Journal]
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_Journal] ([ETL__Source])
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_Journal] ([journal_seq_id])
GO
