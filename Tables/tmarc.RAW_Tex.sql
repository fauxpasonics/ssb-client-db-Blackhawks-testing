...
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_Tex] ([activity], [event_id], [section_id], [row_id], [seat_num], [num_seats], [add_datetime])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_Tex] ([ETL__Source])
GO
