...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_tmarc_RAW_Ticket] ON [tmarc].[RAW_Ticket]
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_Ticket] ([ETL__Source])
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_Ticket] ([ticket_status], [event_id], [section_id], [row_id], [seat_num], [return_datetime])
GO
