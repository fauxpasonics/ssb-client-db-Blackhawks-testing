...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_tmarc_RAW_CustAttrib] ON [tmarc].[RAW_CustAttrib]
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_CustAttrib] ([acct_id], [cust_name_id], [attrib_id], [attrib_seq_num])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_CustAttrib] ([ETL__Source])
GO
