...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_tmarc_RAW_HeldSeats] ON [tmarc].[RAW_HeldSeats]
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_HeldSeats] ([ETL__Source])
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_HeldSeats] ([event_id], [section_id], [row_id], [seat_num])
GO
