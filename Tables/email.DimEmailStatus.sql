...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Creat__5D72A762] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Updat__5E66CB9B] DEFAULT (getdate()),
