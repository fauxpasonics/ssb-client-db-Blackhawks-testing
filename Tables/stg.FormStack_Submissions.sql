...
[RecordCreateDate] [datetime] NOT NULL CONSTRAINT [DF__FormStack__Recor__6AC68E7D] DEFAULT (getutcdate()),
[Processed] [bit] NOT NULL CONSTRAINT [DF__FormStack__Proce__6BBAB2B6] DEFAULT ((0)),
