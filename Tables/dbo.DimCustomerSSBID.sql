...
GO
CREATE NONCLUSTERED INDEX [IX_DIMCUSTOMERSSBID_PRIMARY_FLAG_INCLUDE] ON [dbo].[DimCustomerSSBID] ([SSB_CRMSYSTEM_PRIMARY_FLAG]) INCLUDE ([DimCustomerId], [SSB_CRMSYSTEM_CONTACT_ID])
GO
