...
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_CustRep] ([acct_id], [acct_rep_id], [acct_rep_type])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_CustRep] ([ETL__Source])
GO
