CREATE TABLE [src].[SubscriberMail_News_RecipientListByMessage]
(
[SK] [bigint] NULL,
...
[L4_AllData_recipientData_dataFields_] [nvarchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
