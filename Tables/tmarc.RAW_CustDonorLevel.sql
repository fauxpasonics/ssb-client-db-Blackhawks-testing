...
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_CustDonorLevel] ([cust_donor_level_id])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_CustDonorLevel] ([ETL__Source])
GO
