...
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_RetailNonTicket] ([ETL__Source])
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_RetailNonTicket] ([retail_event_id], [event_id], [event_name], [section_name], [row_name], [first_seat], [num_seats], [refund_flag])
GO
