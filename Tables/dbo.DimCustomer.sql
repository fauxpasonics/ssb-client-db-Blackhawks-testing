...
GO
CREATE NONCLUSTERED INDEX [IX_DIMCUSTOMER_SOURCESYSTEM_INCLUDE] ON [dbo].[DimCustomer] ([SourceSystem]) INCLUDE ([AccountId], [DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DIMCUSTOMER_SOURCESYSTEM_CUSTOMERTYPE_INCLUDE] ON [dbo].[DimCustomer] ([SourceSystem], [CustomerType]) INCLUDE ([AccountId], [DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DIMCUSTOMER_SOURCESYSTEM_ISDELETED_INCLUDE] ON [dbo].[DimCustomer] ([SourceSystem], [IsDeleted]) INCLUDE ([SSID])
GO
