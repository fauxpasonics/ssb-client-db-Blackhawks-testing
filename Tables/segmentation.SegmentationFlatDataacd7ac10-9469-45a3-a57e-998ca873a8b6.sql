CREATE TABLE [segmentation].[SegmentationFlatDataacd7ac10-9469-45a3-a57e-998ca873a8b6]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataacd7ac10-9469-45a3-a57e-998ca873a8b6] ADD CONSTRAINT [pk_SegmentationFlatDataacd7ac10-9469-45a3-a57e-998ca873a8b6] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataacd7ac10-9469-45a3-a57e-998ca873a8b6] ON [segmentation].[SegmentationFlatDataacd7ac10-9469-45a3-a57e-998ca873a8b6] ([_rn])
GO
