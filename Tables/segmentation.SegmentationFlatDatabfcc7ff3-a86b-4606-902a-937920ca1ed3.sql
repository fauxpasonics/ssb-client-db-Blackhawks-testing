CREATE TABLE [segmentation].[SegmentationFlatDatabfcc7ff3-a86b-4606-902a-937920ca1ed3]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatabfcc7ff3-a86b-4606-902a-937920ca1ed3] ADD CONSTRAINT [pk_SegmentationFlatDatabfcc7ff3-a86b-4606-902a-937920ca1ed3] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatabfcc7ff3-a86b-4606-902a-937920ca1ed3] ON [segmentation].[SegmentationFlatDatabfcc7ff3-a86b-4606-902a-937920ca1ed3] ([_rn])
GO
