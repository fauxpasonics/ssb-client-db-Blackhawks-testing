CREATE TABLE [segmentation].[SegmentationFlatData4bdf46f0-64ca-4073-bb5c-13b0d0f75f01]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData4bdf46f0-64ca-4073-bb5c-13b0d0f75f01] ADD CONSTRAINT [pk_SegmentationFlatData4bdf46f0-64ca-4073-bb5c-13b0d0f75f01] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData4bdf46f0-64ca-4073-bb5c-13b0d0f75f01] ON [segmentation].[SegmentationFlatData4bdf46f0-64ca-4073-bb5c-13b0d0f75f01] ([_rn])
GO
