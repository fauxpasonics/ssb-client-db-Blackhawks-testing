CREATE TABLE [segmentation].[SegmentationFlatData463b029c-d7aa-4b00-bbb8-8843ba5bb024]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData463b029c-d7aa-4b00-bbb8-8843ba5bb024] ADD CONSTRAINT [pk_SegmentationFlatData463b029c-d7aa-4b00-bbb8-8843ba5bb024] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData463b029c-d7aa-4b00-bbb8-8843ba5bb024] ON [segmentation].[SegmentationFlatData463b029c-d7aa-4b00-bbb8-8843ba5bb024] ([_rn])
GO
