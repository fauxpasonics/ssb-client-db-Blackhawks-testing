...
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Source] ON [tmarc].[RAW_ManifestSeat] ([ETL__Source])
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [tmarc].[RAW_ManifestSeat] ([manifest_id], [section_id], [row_id], [seat_num])
GO
