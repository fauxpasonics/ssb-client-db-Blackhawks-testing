...
SELECT SubmissionID, dynamicdata FROM Blackhawks.stg.FormStack_Submissions
SELECT SubmissionID,
...
IF EXISTS (select * from INFORMATION_SCHEMA.tables where CONCAT(TABLE_SCHEMA,'.',TABLE_NAME) = 'ods.FormStack_Attribute_Values')
BEGIN
