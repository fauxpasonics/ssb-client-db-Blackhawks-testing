...
SELECT * FROM [ods].[AsOf_SubscriberMail_News_UnsubscribesByList] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_News_UnsubscribesByList] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_News_UnsubscribesByList]
	) a
WHERE
