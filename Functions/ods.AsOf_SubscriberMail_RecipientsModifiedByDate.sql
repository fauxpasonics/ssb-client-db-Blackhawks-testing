...
SELECT * FROM [ods].[AsOf_SubscriberMail_RecipientsModifiedByDate] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_RecipientsModifiedByDate] (@AsOfDate DATETIME)

RETURNS @Results TABLE
(
[Email] [nvarchar](100) NULL,
[RecipientData_id] [nvarchar](100) NULL,
[DataField_ID] [nvarchar](100) NULL,
[DataField_Value] [nvarchar](200) NULL,
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_RecipientsModifiedByDate]
	) a
WHERE
