...
SELECT * FROM [ods].[AsOf_SubscriberMail_MessageActivity] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_MessageActivity] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_MessageActivity]
	) a
WHERE
