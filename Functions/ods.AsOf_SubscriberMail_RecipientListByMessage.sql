...
SELECT * FROM [ods].[AsOf_SubscriberMail_RecipientListByMessage] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_RecipientListByMessage] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_RecipientListByMessage]
	) a
WHERE
