...
SELECT * FROM [ods].[AsOf_SubscriberMail_News_Lists] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_News_Lists] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_News_Lists]
	) a
WHERE
