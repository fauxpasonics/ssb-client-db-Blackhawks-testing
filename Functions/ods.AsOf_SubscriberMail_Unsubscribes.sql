...
SELECT * FROM [ods].[AsOf_SubscriberMail_Unsubscribes] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_Unsubscribes] (@AsOfDate DATETIME)
...
[UnsubscribeTime] [nvarchar](50) NULL,
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_Unsubscribes]
	) a
WHERE
