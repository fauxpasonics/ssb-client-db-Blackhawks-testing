...
SELECT * FROM [ods].[AsOf_SubscriberMail_News_RecipientActivityByMessage] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_News_RecipientActivityByMessage] (@AsOfDate DATETIME)
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_News_RecipientActivityByMessage]
	) a
WHERE
