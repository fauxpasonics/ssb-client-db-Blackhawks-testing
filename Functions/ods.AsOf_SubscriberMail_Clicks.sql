...
SELECT * FROM [ods].[AsOf_SubscriberMail_Clicks] (@AsOfDate)
*/

CREATE FUNCTION [ods].[AsOf_SubscriberMail_Clicks] (@AsOfDate DATETIME)
...
[Click_Url_Index] [nvarchar](100) NULL,
...
FROM
	...
	FROM [ods].[Snapshot_SubscriberMail_Clicks]
	) a
WHERE
