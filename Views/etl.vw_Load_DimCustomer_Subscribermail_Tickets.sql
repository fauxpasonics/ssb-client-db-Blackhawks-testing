...
CREATE VIEW  [etl].[vw_Load_DimCustomer_Subscribermail_Tickets] AS 
...
 
            /*AddressPrimary*/
            , NULL AS [AddressPrimaryStreet] -- dont load suites combine addresses with multiple lines and load to street eg. CASE WHEN ISNULL(address2,'') <> '' THEN z.street + ' ' + z.address2 ELSE z.street END AS [AddressPrimaryStreet]
...
  		--select count(*)     
        FROM ods.subscribermail_customer_Data z-- WITH (NOLOCK) --Change To Source Table
