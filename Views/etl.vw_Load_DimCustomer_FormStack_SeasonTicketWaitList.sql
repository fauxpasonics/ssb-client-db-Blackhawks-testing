...
CREATE VIEW [etl].[vw_Load_DimCustomer_FormStack_SeasonTicketWaitList] AS 
...
 
            /*Standard Attributes*/
            , CAST(z.UniqueID AS NVARCHAR(200)) [SSID] -- Required, must be cast as NVARCHAR(200)
...
            , z.Address2 AS [AddressPrimarySuite] -- ALWAYS LEAVE THIS NULL!!!!!!!!!!!!!!!!
            , z.City AS [AddressPrimaryCity] 
            , z.State  AS [AddressPrimaryState] 
            , z.[Zip code] AS [AddressPrimaryZip] 
...
 
            /*Phone*/
            , LEFT(z.[day phone],25) AS [PhonePrimary] -- For Coalescing values make sute they are wrapped in a NULLIF for values that = '' eg COALESCE(NULLIF(z.mobile,''),z.phone) AS [PhonePrimary]
            , LEFT(z.[Evening Phone],25) AS [PhoneHome]
...
 
            /*Email*/
            , CAST(z.[Email Address] AS NVARCHAR(256)) AS [EmailPrimary]
...
            , z.Time AS [SSCreatedDate] --createddate
            , z.Time AS [SSUpdatedDate] --lastmodifiedbyid
...
        --SELECT COUNT(*)           
        FROM [stg].[SeasonTicketWaitList201617] z WITH (NOLOCK) --Change To Source Table
