...
CREATE VIEW [etl].[vw_Load_DimCustomer_FormStack_LastMinuteTicketNotification] AS 
...
        --SELECT COUNT(*)           
        FROM [stg].[201617LastMinuteTicketNotification2] z WITH (NOLOCK) --Change To Source Table
